...
paper_pmid = 27905431
paper_name = 'aviram_schuldiner_2016' 
...
original_data = pd.read_excel('raw_data/nature20169-s2.xlsx', sheet_name='Sheet1', skiprows=3)
...
# Removing missing strains (they were tested as DAMPs)
