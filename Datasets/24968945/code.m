...
% Load data (1)
[FILENAMES{end+1}, data_sens.raw] = dataread('xlsread','raw_data/1471-2164-15-528-s1.xlsx', 'Top sensitive strains');
...
% Load data (2)
[FILENAMES{end+1}, data_res.raw] = dataread('xlsread','raw_data/1471-2164-15-528-s1.xlsx', 'Top resistant strains');
...
% Load tested
[FILENAMES{end+1}, tested.raw] = dataread('xlsread','raw_data/CompleteDeletionLibrary.xlsx');
...
a = a(1:end-4);
save([a,'gaupel_tenniswood_2004.mat'],'gaupel_tenniswood_2004');
return;
