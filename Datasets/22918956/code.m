...
FILENAMES = {};
krumpe_schuldiner_2012.pmid = 22918956;

% MANUAL. Download the list of dataset ids and standard names from
% the paper's page on www.yeastphenome.org & save the file to ./extras

% Load the list
[FILENAMES{end+1}, d] = read_data('textread', ['./extras/YeastPhenome_' num2str(krumpe_schuldiner_2012.pmid) '_datasets_list.txt'],'%d %s','delimiter','\t');
datasets.id = d{1};
...
krumpe_schuldiner_2012.orfs = tested_strains;
krumpe_schuldiner_2012.ph = hit_data_names;
krumpe_schuldiner_2012.data = zeros(length(krumpe_schuldiner_2012.orfs),length(krumpe_schuldiner_2012.ph));
krumpe_schuldiner_2012.dataset_ids = hit_data_ids;

[~,ind1,ind2] = intersect(hit_strains, krumpe_schuldiner_2012.orfs);
krumpe_schuldiner_2012.data(ind2,:) = hit_data(ind1,:);

%% Save

save('./krumpe_schuldiner_2012.mat','krumpe_schuldiner_2012');

%% Print out

fid = fopen('./krumpe_schuldiner_2012.txt','w');
write_matrix_file(fid, krumpe_schuldiner_2012.orfs, krumpe_schuldiner_2012.ph, krumpe_schuldiner_2012.data);
fclose(fid);
...
if exist('save_data_to_db.m')
    res = save_data_to_db(krumpe_schuldiner_2012)
end
