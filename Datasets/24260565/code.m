...
FILENAMES = {};
gaytan_vulpe_2013.pmid = 24260565;
...
[FILENAMES{end+1}, data] = read_data('xlsread','./raw_data/journal.pone.0081253.s003.xlsx', 'mutants with altered growth in ');

% Get the list of ORFs and the correponding data 
% (this part usually changes significantly based on the format of the raw data file)
hit_strains = data(7:end,1);

% Get the data itself
hit_data = data(7:end,2:4);
