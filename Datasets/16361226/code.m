...
[FILENAMES{end+1}, mapdata.raw] = dataread('xlsread',filename, sheets{sht});
...
[FILENAMES{end+1}, C] = dataread('importdata','Datasets/Phenotypes/2006_Cai~Becker/summary2.txt', '\t');
...
[FILENAMES{end+1}, A] = dataread('dlmread',filename, '\t', [data_row_num(d) 0 data_row_num(d)+7 11]);
...
a = a(1:end-4);
save([a,'cai_becker_2006.mat'],'cai_becker_2006');
return;
